...
void RelocalizeWidgetMenuCheckboxes(UiLanguage previous_language) {
    for (MenuCheckboxState& checkbox : g_checkboxes.checkboxes) {
        checkbox.spec.checked_text = RelocalizeText(checkbox.spec.checked_text, previous_language);
        checkbox.spec.unchecked_text = RelocalizeText(checkbox.spec.unchecked_text, previous_language);
    }
}
