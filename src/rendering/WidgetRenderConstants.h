...
// Marge interieure du panneau en mode minimal en DIPs.
constexpr float kMinimalPanelPadding = 14.0F;

// Taille renforcee des libelles du mode minimal en DIPs.
constexpr float kMinimalLabelTextSize = 13.0F;

// Taille renforcee des valeurs du mode minimal en DIPs.
